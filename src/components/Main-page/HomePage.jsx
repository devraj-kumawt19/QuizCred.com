      ...
      <Container fluid>
        ...
        <div class="row1-container">
          ...
          <div class="box red">
            ...
            <h4><b>Prize</b>: Rs. 7000 <br />Swags & Promo Codes<br /><br /><a href="https://quizcred.devfolio.co/#prizes">Load More</a></h4>
          </div>

          <div class="box box-down cyan">
            <h2>Overall Second</h2><img className="imgright" src="https://img.icons8.com/emoji/96/000000/2nd-place-medal-emoji.png" alt="" />
            <h4><b>Prize</b>: Rs. 3000 <br />Swags & Promo Codes<br /><br /><a href="https://quizcred.devfolio.co/#prizes">Load More</a></h4>
          </div>

          <div class="box box-down blue">
            <h2>Overall Third</h2><img class="imgright" src="https://img.icons8.com/emoji/96/000000/3rd-place-medal-emoji.png" alt="" />
            <h4><b>Prize</b>: Rs. 2000 <br />Swags & Promo Codes<br /><br /><a href="https://quizcred.devfolio.co/#prizes">Load More</a></h4>
          </div>
        </div>
        ...
        <div class="row1-container margfromsponsor">
          <div class="box box-down color2">
            ...
            <h4><b>Prize</b>: Rs. 1500 <br />Swags & Promo Codes<br /><br /><a href="https://quizcred.devfolio.co/#prizes">Load More</a></h4>
          </div>
          ...
          <div class="box box-down orange">
            ...
            <h4><b>Participation Certificate</b><br />Promo Codes<br /><br /><a href="https://quizcred.devfolio.co/#prizes">Load More</a></h4>
          </div>
        </div>
