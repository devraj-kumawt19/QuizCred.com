...
import me from "./Assets/teami/me.jpg";
import dharmesh from "./Assets/teami/vishal.png";
...
import ayush from "./Assets/teami/vishal.png";
...
const SOCIALS = {
  ...
  mail: "contact@quizcred.tech"
};

const MIDDLE_SECTION = {
  TITLE: "What is QuizCred?",
  LONG_DESCRIPTION:
  ...
  [
    [
      ...
      },
      {
        ...
        content: "QuizCred is open to all undergraduate, high school students, and middle school students from all schools. Unfortunately, only DDU students can attend this event offline. For the rest of the other students, the event would be online."
      },
      {
    ...
    [
      ...
      },
      {
        ...
        content: "Reach us directly at (contact@quizcred.tech) we would happy to help you."
      }
      ,
      {
